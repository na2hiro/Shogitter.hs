...
spec = do
    describe "Freeze canMove"$
        let s = pseudoDoMove (Move (Coord 7 7) (Coord 7 6) False) initialBoard { getMoverPredicator = freezeMoverPredicator }
    ...
    describe "Madras canMove"$
        let s = pseudoDoMove (Move (Coord 7 7) (Coord 7 6) False) initialBoard { getMoverPredicator = madrasMoverPredicator }
